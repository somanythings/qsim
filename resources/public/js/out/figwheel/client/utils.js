...
var or__26349__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj33255 = {"detail":data};
return obj33255;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__26337__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__26337__auto__)){
var and__26337__auto____$1 = (window["CustomEvent"]);
...
var args33260 = [];
var len__27462__auto___33266 = arguments.length;
var i__27463__auto___33267 = (0);
while(true){
if((i__27463__auto___33267 < len__27462__auto___33266)){
args33260.push((arguments[i__27463__auto___33267]));

var G__33268 = (i__27463__auto___33267 + (1));
i__27463__auto___33267 = G__33268;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args33260.length)].join('')));
...
var f = (function (){var pred__33263 = cljs.core._EQ_;
var expr__33264 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33263.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33264))){
return ((function (pred__33263,expr__33264){
return (function (p1__33256_SHARP_){
return console.warn(p1__33256_SHARP_);
});
;})(pred__33263,expr__33264))
} else {
if(cljs.core.truth_(pred__33263.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33264))){
return ((function (pred__33263,expr__33264){
return (function (p1__33257_SHARP_){
return console.debug(p1__33257_SHARP_);
});
;})(pred__33263,expr__33264))
} else {
if(cljs.core.truth_(pred__33263.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33264))){
return ((function (pred__33263,expr__33264){
return (function (p1__33258_SHARP_){
return console.error(p1__33258_SHARP_);
});
;})(pred__33263,expr__33264))
} else {
return ((function (pred__33263,expr__33264){
return (function (p1__33259_SHARP_){
return console.log(p1__33259_SHARP_);
});
;})(pred__33263,expr__33264))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33270){
var map__33273 = p__33270;
...
var eval_fn = cljs.core.get.call(null,map__33273__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33275_SHARP_);
});})(new_def))
);
...
return (function (p__33276){
var vec__33277 = p__33276;
var ky = cljs.core.nth.call(null,vec__33277,(0),null);
var v = cljs.core.nth.call(null,vec__33277,(1),null);
...
var args33280 = [];
var len__27462__auto___33283 = arguments.length;
var i__27463__auto___33284 = (0);
while(true){
if((i__27463__auto___33284 < len__27462__auto___33283)){
args33280.push((arguments[i__27463__auto___33284]));

var G__33285 = (i__27463__auto___33284 + (1));
i__27463__auto___33284 = G__33285;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args33280.length)].join('')));
...
if(cljs.core.truth_((function (){var and__26337__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1494453156266