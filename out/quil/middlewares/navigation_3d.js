...
var vec__35182 = axis;
var a_x = cljs.core.nth.call(null,vec__35182,(0),null);
var a_y = cljs.core.nth.call(null,vec__35182,(1),null);
var a_z = cljs.core.nth.call(null,vec__35182,(2),null);
var vec__35185 = v;
var x = cljs.core.nth.call(null,vec__35185,(0),null);
var y = cljs.core.nth.call(null,vec__35185,(1),null);
var z = cljs.core.nth.call(null,vec__35185,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__35188,p__35189){
var vec__35196 = p__35188;
var u1 = cljs.core.nth.call(null,vec__35196,(0),null);
var u2 = cljs.core.nth.call(null,vec__35196,(1),null);
var u3 = cljs.core.nth.call(null,vec__35196,(2),null);
var vec__35199 = p__35189;
var v1 = cljs.core.nth.call(null,vec__35199,(0),null);
var v2 = cljs.core.nth.call(null,vec__35199,(1),null);
var v3 = cljs.core.nth.call(null,vec__35199,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__35202_SHARP_){
return (p1__35202_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__35203_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__35204_SHARP_,angle_lr),angle_ud);
...
var map__35211 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__35211__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__35211__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__35213 = cljs.core._EQ_;
var expr__35214 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__35213.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__35214))){
return straight;
} else {
if(cljs.core.truth_(pred__35213.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__35214))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__35213.call(null,quil.middlewares.navigation_3d.space,expr__35214))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__35213.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__35214))){
return up;
} else {
if(cljs.core.truth_(pred__35213.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__35214))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__35213.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__35214))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__35211,map__35211__$1,up,straight){
return (function (p1__35205_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__35205_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__35211,map__35211__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__35216_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__35216_SHARP_);
});})(initial_state))
);
});
/**
...
var map__35228_35239 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__35228_35240__$1 = ((((!((map__35228_35239 == null)))?((((map__35228_35239.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35228_35239.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__35228_35239):map__35228_35239);
var vec__35229_35241 = cljs.core.get.call(null,map__35228_35240__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_35242 = cljs.core.nth.call(null,vec__35229_35241,(0),null);
var c_y_35243 = cljs.core.nth.call(null,vec__35229_35241,(1),null);
var c_z_35244 = cljs.core.nth.call(null,vec__35229_35241,(2),null);
var vec__35232_35245 = cljs.core.get.call(null,map__35228_35240__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_35246 = cljs.core.nth.call(null,vec__35232_35245,(0),null);
var u_y_35247 = cljs.core.nth.call(null,vec__35232_35245,(1),null);
var u_z_35248 = cljs.core.nth.call(null,vec__35232_35245,(2),null);
var vec__35235_35249 = cljs.core.get.call(null,map__35228_35240__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_35250 = cljs.core.nth.call(null,vec__35235_35249,(0),null);
var p_y_35251 = cljs.core.nth.call(null,vec__35235_35249,(1),null);
var p_z_35252 = cljs.core.nth.call(null,vec__35235_35249,(2),null);
quil.core.camera.call(null,p_x_35250,p_y_35251,p_z_35252,(p_x_35250 + c_x_35242),(p_y_35251 + c_y_35243),(p_z_35252 + c_z_35244),u_x_35246,u_y_35247,u_z_35248);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1494451919628